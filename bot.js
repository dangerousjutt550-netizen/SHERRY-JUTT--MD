...
OWNER_NUMBER: process.env.OWNER_NUMBER || "923139741395",
OWNER_NAME: process.env.OWNER_NAME || "SHERRY JUTTMD Official",
ST_SAVE: process.env.ST_SAVE || "KIRA-MD-STATUS-SERVER",
BIO_TEXT: process.env.BIO_TEXT || "SHERRY JUTT-MD-BY-SHERRY JUTTMD-OFFICIAL",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY KIRA-MD`* _*POWERD BY*_ *SHERRY JUTT MD Official Whtsapp Bot*",
FOOTER: process.env.FOOTER || "KIRA-MD",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ KIRA-MD BY SHERRY JUTT-MD OFFICIAL*",
VERSION: process.env.VERSION || "9.0.0",
NEWSLETTER: process.env.NEWSLETTER || "120363348739987203@newsletter",
WA_CHANNEL: process.env.WA_CHANNEL || "https://whatsapp.com/channel/0029VbCr5mI47XeA6o6nKs1U
INSTA: process.env.INSTA || "https://www.instagram.com/itx_shehrozjutt?igsh=MXhrb2E0bW4xbXJ6Nw==
